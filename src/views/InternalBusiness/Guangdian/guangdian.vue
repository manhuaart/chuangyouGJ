    ...
    <div class="app-container">
        <el-form>
            <el-form style="width:100%;display: flex;">
                ...
                <el-date-picker v-model="dateList" type="datetimerange" :picker-options="pickerOptions" range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期" align="right" style="margin-left:8px;">
                </el-date-picker>
            </el-form>
            <el-form-item>
                ...
                <div class="right-items" style="float: right;">
                    ...
                    <el-button type="warning" icon="el-icon-download" size="mini" v-if="tableTpye==true" @click="handleQuery('tdata','all')">
                        导出所有数据</el-button>
                    <el-button type="warning" icon="el-icon-download" size="mini" v-else @click="export2Excel(tableData2Excel)">
                        导出侵权数据</el-button>
                </div>
            </el-form-item>
        </el-form>
        ...
        <el-table v-if="tableTpye" :data="showData" v-loading="loadDataType" @selection-change="handleSelection" max-height="650" height="650">
            ...
            <el-table-column label="样本标题" align="center" prop="sample_title">
                <template slot-scope="scope">
                    <el-input placeholder="请输入内容" v-if="project!='shumu'" alt="scope.row.sample_title" v-model="scope.row.sample_title" clearable>
                    </el-input>
                </template>
            </el-table-column>
            <el-table-column label="样本链接" align="center" prop="sample_url" show-overflow-tooltip>
                <template slot-scope="scope">
                    <el-input placeholder="请输入内容" v-if="project!='shumu'" v-model="scope.row.sample_url" clearable>
                    </el-input>
                </template>
            </el-table-column>
            ...
            <el-table-column label="操作" align="center" class-name="small-padding fixed-width" fixed="right">
                <template slot-scope="scope">
                    <el-button size="mini" type="text" @click.native.prevent="addRow(scope.$index, showData)">确认</el-button>
                    <el-button size="mini" type="text" icon="el-icon-delete" @click="handleDelete(scope.$index, showData)">删除</el-button>
                </template>
            </el-table-column>
        </el-table>
        <!-- --------------else------------------ -->
...
export default {
    ...
    methods: {
        ...
        handleDelete(index, rows) {
            ...
            axios
                .post(this.url + "/data_Manipulation/data_operation/", data, {
                    headers: {
        ...
        addRow(index, rows) {
            ...
            axios
                .post(
                    this.url + "/data_Manipulation/data_operation/",
                    formData,
                    {
                        headers: {
                            token: localStorage.getItem("token"),
        ...
        handleQuery(type, page, check) {
            ...
            axios
                .get(
                    this.url + "/data_Manipulation/search_data/",
                    {
                        dataType: "text",
                        params: {
                            type: type,
                ...
                .then((res) => {
                    ...
                    for (const index in res.data.content) {
                        if (this.project == "tv") {
                            ...
                            res.data.content[index].sample_key =
                                res.data.content[index].works;
                        ...
                        var timestamp4 = new Date(
                            res.data.content[index].detection_time * 1000
                        );
                        res.data.content[index].detection_time =
                            timestamp4
                                .toLocaleDateString()
                                .replace(/\//g, "-") +
                            " " +
        ...
        activationTimeFormat(row, column) {
            ...
            var date1 = DateUtils.formatTimeToStr(
                testTime,
                "yyyy-MM-dd hh:mm:ss"
            );
            return date1;
