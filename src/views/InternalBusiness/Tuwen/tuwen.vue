...
//------------------------------
   ...
   export2Excel(dataList) {
       ...
       //头部
       const tHeader = ['样本标题', '样本链接', '作品名称', '侵权标题', '侵权链接',  '侵权发布者', '侵权发布时间','播放次数','爬取时间']
       //对应的标签
       const filterVal=['sample_title', 'sample_url', 'sample_key', 'tort_title', 'tort_url','tort_author', 'tort_putdate', 'tort_plays', 'detection_time']
       //标签对应的内容  是一个数组结构
        let self = this;
       const list = dataList;
