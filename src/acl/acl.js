...
//定义用于路由和任何组件访问的全局规则
  globalRules: {
    p6: new AclRule('p6').generate(),  //只有leavCy为p0能看到的
    p5: new AclRule('p5').or('p6').generate(), //只有leavCy为p1或者p0能看到的
    p4: new AclRule('p4').or('p5').or('p6').generate(),
    p3: new AclRule('p3').or('p4').or('p5').or('p6').generate(),
    p2: new AclRule('p2').or('p3').or('p4').or('p5').or('p6').generate(), 
    p1: new AclRule('p1').or('p2').or('p3').or('p4').or('p5').or('p6').generate(),   
